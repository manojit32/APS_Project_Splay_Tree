...
print(avg_del_bl) 
print(avg_del_sl)
plt.plot(maxl,avg_del_bl,'o-')
plt.plot(maxl,avg_del_sl,'x-')
plt.title("Deletion")
plt.show()
plt.plot(maxl,avg_pretty_uneven_b10l,'o-')
plt.plot(maxl,avg_pretty_uneven_s10l,'x-')
plt.title("10 elements")
plt.show()
plt.plot(maxl,avg_pretty_uneven_b4l,'o-')
plt.plot(maxl,avg_pretty_uneven_s4l,'x-')
plt.show()
plt.title("4 elements")
plt.plot(maxl,avg_very_uneven_bl,'o-')
plt.plot(maxl,avg_very_uneven_sl,'x-')
plt.title("single element")
plt.show()
plt.plot(maxl,avg_uni_bl,'o-')
plt.plot(maxl,avg_uni_sl,'x-')
